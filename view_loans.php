	...
	var handleDataTableButtons = function() {
	  if ($("#datatable-buttons").length) {
		dTable = $('#datatable-buttons').DataTable({
		  ...
		  columns:[ { data: 'loan_number', render: function ( data, type, full, meta ) {return '<a href="member-details.php?p_id='+full.person_number+'&view=client_loan&lid='+full.id+'" title="View details">'+data+'</a>';}},
